        ...
        {activeTab === "details" && (
          <div className="text-sm" style={{ color: "#d1d5db" }}>
            <div className="grid grid-cols-2 gap-x-8 gap-y-4">
              <div>
                <span className="font-semibold block mb-1" style={{ color: "#ffffff" }}>
                  Material
                </span>
        ...
        {activeTab === "shipping" && (
          <div className="flex flex-col gap-y-6">
            <div className="flex items-start gap-x-3">
              <div style={{ color: "#4ade80", flexShrink: 0, marginTop: "2px" }}>
                <FastDelivery />
              </div>
              <div>
                <span className="font-semibold text-sm block mb-1" style={{ color: "#ffffff" }}>
                  Schnelle Lieferung
                </span>
