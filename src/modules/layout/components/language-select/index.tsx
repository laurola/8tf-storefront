    ...
    <div>
      ...
      >
        ...
        <div className="flex relative w-full min-w-[320px]">
          ...
          >
            <ListboxOptions
              className="absolute -bottom-[calc(100%-36px)] left-0 xsmall:left-auto xsmall:right-0 max-h-[442px] overflow-y-scroll z-[900] bg-white drop-shadow-md text-small-regular uppercase text-gray-900 no-scrollbar rounded-rounded w-full border border-gray-200"
              static
            >
              {options.map((o) => (
                <ListboxOption
